...
const AuthLogin = () => {
  ...
  return (
    <div className="md:flex w-full rounded justify-center">
      <div className="md:w-1/4 bg-white py-24 px-12 rounded-t-lg md:rounded-l-lg  md:rounded-r-none">
        ...
        <div className="flex justify-center w-full mt-12">
          <button
            className="test-class font-inter_bold hover:bg-blue-500 text-blue-500 hover:text-white
